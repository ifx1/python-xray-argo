...
UUID = os.environ.get('UUID', 'ca29346e-1983-421c-8fd0-b187dc2d914c')       # UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.xii.pp.ua:443')                  # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')                           # 哪吒端口为{443,8443,2096,2097,2083}其中之一时自动开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'yk9ERCG9mi3He0c3yPM796bcnLTE1NqU')                                 # 哪吒客户端密钥
